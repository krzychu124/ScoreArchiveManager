...
public abstract class AbstractFileMetadataArchive {
    ...
    AbstractFileMetadataArchive(AbstractFileMetadata fileMetadata) {
    ...
    public static String generateFileName(AbstractFileMetadataArchive metadata){
